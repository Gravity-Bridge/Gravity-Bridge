...
use gravity_proto::gravity::v1::OutgoingLogicCall as ProtoLogicCall;
use gravity_proto::gravity::v1::OutgoingTxBatch as ProtoBatch;
use gravity_proto::gravity::v1::Valset as ProtoValset;
