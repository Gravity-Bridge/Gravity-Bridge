...
use deep_space::{
    ...
    Contact, CosmosPrivateKey, PrivateKey,
};
use gravity_proto::{
...
pub const USER: &str = "gravity1hanqss6jsq66tfyjz56wz44z0ejtyv0724h32c";
...
pub async fn eip_712_test(
    ...
    // Finally, test that a bad deep_space transaction (invalid signature) produces a similar error
