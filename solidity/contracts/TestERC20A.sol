...
contract TestERC20A is ERC20 {
	constructor() ERC20("Bitcoin MAX", "MAX") {
		...
		// this is the address of our testnet miner (the geth developer-mode
		// account set up in tests/container-scripts/run-eth.sh) so it will have
		// both a lot of ETH and a lot of erc20 tokens to test with
