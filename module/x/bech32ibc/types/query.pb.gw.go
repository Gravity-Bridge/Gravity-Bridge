...
var (
	pattern_Query_HrpIbcRecords_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"osmosis", "txfees", "v1beta1", "hrp_ibc_records"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_HrpIbcRecord_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"osmosis", "txfees", "v1beta1", "hrp_source_channel", "hrp"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_NativeHrp_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"osmosis", "txfees", "v1beta1", "native_hrp"}, "", runtime.AssumeColonVerbOpt(true)))
)
