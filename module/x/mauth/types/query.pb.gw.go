...
var (
	pattern_Query_InterchainAccountFromAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"mauth", "v1beta1", "address-to-ica"}, "", runtime.AssumeColonVerbOpt(true)))
)
