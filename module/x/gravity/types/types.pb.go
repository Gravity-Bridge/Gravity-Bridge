...
// EVMChainProposal defines struct for different supported EVM chains data
// Prefix: short EVM chain name that is used as key
// Chain name: full chain name
type EVMChainProposal struct {
	Prefix    string `protobuf:"bytes,1,opt,name=prefix,proto3" json:"prefix,omitempty"`
	ChainName string `protobuf:"bytes,2,opt,name=chain_name,json=chainName,proto3" json:"chain_name,omitempty"`
}

func (m *EVMChainProposal) Reset()         { *m = EVMChainProposal{} }
func (m *EVMChainProposal) String() string { return proto.CompactTextString(m) }
func (*EVMChainProposal) ProtoMessage()    {}
func (*EVMChainProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_163831c23fcc179f, []int{8}
}
func (m *EVMChainProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EVMChainProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EVMChainProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EVMChainProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EVMChainProposal.Merge(m, src)
}
func (m *EVMChainProposal) XXX_Size() int {
	return m.Size()
}
func (m *EVMChainProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_EVMChainProposal.DiscardUnknown(m)
}

var xxx_messageInfo_EVMChainProposal proto.InternalMessageInfo

func (m *EVMChainProposal) GetPrefix() string {
	if m != nil {
		return m.Prefix
	}
	return ""
...
func (m *EVMChainProposal) GetChainName() string {
	if m != nil {
		return m.ChainName
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*EVMChainProposal)(nil), "gravity.v1.EVMChainProposal")
}
...
var fileDescriptor_163831c23fcc179f = []byte{
	...
	,
}
...
func (m *EVMChainProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EVMChainProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EVMChainProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EVMChainProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EVMChainProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EVMChainProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EVMChainProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
