...
// store
type SetMonitoredERC20TokensProposal struct {
	Title       string   `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	Description string   `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	Erc20Tokens []string `protobuf:"bytes,3,rep,name=erc20_tokens,json=erc20Tokens,proto3" json:"erc20_tokens,omitempty"`
}

func (m *SetMonitoredERC20TokensProposal) Reset()      { *m = SetMonitoredERC20TokensProposal{} }
func (*SetMonitoredERC20TokensProposal) ProtoMessage() {}
func (*SetMonitoredERC20TokensProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_163831c23fcc179f, []int{7}
}
func (m *SetMonitoredERC20TokensProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SetMonitoredERC20TokensProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SetMonitoredERC20TokensProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SetMonitoredERC20TokensProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetMonitoredERC20TokensProposal.Merge(m, src)
}
func (m *SetMonitoredERC20TokensProposal) XXX_Size() int {
	return m.Size()
}
func (m *SetMonitoredERC20TokensProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_SetMonitoredERC20TokensProposal.DiscardUnknown(m)
}

var xxx_messageInfo_SetMonitoredERC20TokensProposal proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*SetMonitoredERC20TokensProposal)(nil), "gravity.v1.SetMonitoredERC20TokensProposal")
...
var fileDescriptor_163831c23fcc179f = []byte{
	...
	,
}
...
func (this *SetMonitoredERC20TokensProposal) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SetMonitoredERC20TokensProposal)
	if !ok {
		that2, ok := that.(SetMonitoredERC20TokensProposal)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.Erc20Tokens) != len(that1.Erc20Tokens) {
		return false
	}
	for i := range this.Erc20Tokens {
		if this.Erc20Tokens[i] != that1.Erc20Tokens[i] {
			return false
		}
	}
	return true
...
func (m *SetMonitoredERC20TokensProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SetMonitoredERC20TokensProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SetMonitoredERC20TokensProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Erc20Tokens) > 0 {
		for iNdEx := len(m.Erc20Tokens) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Erc20Tokens[iNdEx])
			copy(dAtA[i:], m.Erc20Tokens[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.Erc20Tokens[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *SetMonitoredERC20TokensProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SetMonitoredERC20TokensProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SetMonitoredERC20TokensProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SetMonitoredERC20TokensProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Erc20Tokens", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Erc20Tokens = append(m.Erc20Tokens, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
