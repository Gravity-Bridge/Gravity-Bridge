...
type AddEvmChain struct {
	EvmChainName   string `protobuf:"bytes,1,opt,name=evm_chain_name,json=evmChainName,proto3" json:"evm_chain_name,omitempty"`
...
func (m *AddEvmChain) Reset()         { *m = AddEvmChain{} }
func (m *AddEvmChain) String() string { return proto.CompactTextString(m) }
func (*AddEvmChain) ProtoMessage()    {}
func (*AddEvmChain) Descriptor() ([]byte, []int) {
	return fileDescriptor_163831c23fcc179f, []int{8}
}
func (m *AddEvmChain) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AddEvmChain) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AddEvmChain.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AddEvmChain) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddEvmChain.Merge(m, src)
}
func (m *AddEvmChain) XXX_Size() int {
	return m.Size()
}
func (m *AddEvmChain) XXX_DiscardUnknown() {
	xxx_messageInfo_AddEvmChain.DiscardUnknown(m)
}

var xxx_messageInfo_AddEvmChain proto.InternalMessageInfo

func (m *AddEvmChain) GetEvmChainName() string {
	if m != nil {
...
func (m *AddEvmChain) GetEvmChainPrefix() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*AddEvmChain)(nil), "gravity.v1.AddEvmChain")
}
...
var fileDescriptor_163831c23fcc179f = []byte{
	...
	,
}
...
func (m *AddEvmChain) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AddEvmChain) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AddEvmChain) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AddEvmChain) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddEvmChain: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddEvmChain: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
