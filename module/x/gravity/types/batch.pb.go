...
func (m *OutgoingTxBatch) GetCosmosBlockCreated() uint64 {
	if m != nil {
		return m.CosmosBlockCreated
	}
	return 0
}
...
func (m *OutgoingLogicCall) GetCosmosBlockCreated() uint64 {
	if m != nil {
		return m.CosmosBlockCreated
	}
	return 0
...
type EventOutgoingBatch struct {
	...
	BatchId        string   `protobuf:"bytes,3,opt,name=batch_id,json=batchId,proto3" json:"batch_id,omitempty"`
	Nonce          string   `protobuf:"bytes,4,opt,name=nonce,proto3" json:"nonce,omitempty"`
	BatchedTxIds   []uint64 `protobuf:"varint,5,rep,packed,name=batched_tx_ids,json=batchedTxIds,proto3" json:"batched_tx_ids,omitempty"`
}
...
func (m *EventOutgoingBatch) GetBatchedTxIds() []uint64 {
	if m != nil {
		return m.BatchedTxIds
	}
	return nil
}
...
var fileDescriptor_4453b445b0660cab = []byte{
	...
	,
}
...
func (m *OutgoingTxBatch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.CosmosBlockCreated != 0 {
		i = encodeVarintBatch(dAtA, i, uint64(m.CosmosBlockCreated))
		i--
		dAtA[i] = 0x28
	}
...
func (m *EventOutgoingBatch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BatchedTxIds) > 0 {
		dAtA4 := make([]byte, len(m.BatchedTxIds)*10)
		var j3 int
		for _, num := range m.BatchedTxIds {
			for num >= 1<<7 {
		...
		i = encodeVarintBatch(dAtA, i, uint64(j3))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Nonce) > 0 {
...
func (m *OutgoingTxBatch) Size() (n int) {
	...
	if m.CosmosBlockCreated != 0 {
		n += 1 + sovBatch(uint64(m.CosmosBlockCreated))
	}
	return n
}
...
func (m *OutgoingTxBatch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CosmosBlockCreated", wireType)
			}
			m.CosmosBlockCreated = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowBatch
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CosmosBlockCreated |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 5:
			if wireType == 0 {
				...
				m.BatchedTxIds = append(m.BatchedTxIds, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.BatchedTxIds) == 0 {
					m.BatchedTxIds = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field BatchedTxIds", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipBatch(dAtA[iNdEx:])
