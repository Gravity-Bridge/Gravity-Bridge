...
//
// eip712_bridge_foreign_chain_ids
//
// A whitelist of foreign EVM chain IDs to accept for EIP712-signed bridging transactions, which must be a Tx
// with a single MsgSendToEth or MsgCancelSendToEth and no other Msgs. The likelihood of replay attacks introduced
// by this change is very low, as EIP712 signatures are over the Gravity Cosmos chain ID and an EVM chain ID.
// By restricting these Txs to only a single bridging
type Params struct {
	...
	Eip712BridgeForeignChainIds []uint64                               `protobuf:"varint,22,rep,packed,name=eip712_bridge_foreign_chain_ids,json=eip712BridgeForeignChainIds,proto3" json:"eip712_bridge_foreign_chain_ids,omitempty"`
}
...
func (m *Params) GetEip712BridgeForeignChainIds() []uint64 {
	if m != nil {
		return m.Eip712BridgeForeignChainIds
	}
	return nil
}
...
var fileDescriptor_387b0aba880adb60 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.Eip712BridgeForeignChainIds) > 0 {
		dAtA2 := make([]byte, len(m.Eip712BridgeForeignChainIds)*10)
		var j1 int
		for _, num := range m.Eip712BridgeForeignChainIds {
			for num >= 1<<7 {
...
func (m *Params) Size() (n int) {
	...
	if len(m.Eip712BridgeForeignChainIds) > 0 {
		l = 0
		for _, e := range m.Eip712BridgeForeignChainIds {
	...
	for iNdEx < l {
		...
		case 22:
			if wireType == 0 {
				...
				m.Eip712BridgeForeignChainIds = append(m.Eip712BridgeForeignChainIds, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.Eip712BridgeForeignChainIds) == 0 {
					m.Eip712BridgeForeignChainIds = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field Eip712BridgeForeignChainIds", wireType)
			}
		default:
			iNdEx = preIndex
