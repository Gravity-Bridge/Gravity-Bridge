...
func RegisterInterfaces(registry types.InterfaceRegistry) {
	...
	registry.RegisterImplementations((*govtypes.Content)(nil), &UnhaltBridgeProposal{}, &AirdropProposal{}, &IBCMetadataProposal{}, &AddEvmChainProposal{}, &RemoveEvmChainProposal{})
