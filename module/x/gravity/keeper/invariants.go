...
func sumUnconfirmedBatchModuleBalances(ctx sdk.Context, k Keeper, expectedBals map[string]*sdkmath.Int) map[string]*sdkmath.Int {
...
func sumUnbatchedTxModuleBalances(ctx sdk.Context, k Keeper, expectedBals map[string]*sdkmath.Int) map[string]*sdkmath.Int {
...
func sumPendingIbcAutoForwards(ctx sdk.Context, k Keeper, expectedBals map[string]*sdkmath.Int) map[string]*sdkmath.Int {
