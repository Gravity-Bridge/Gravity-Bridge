...
func RegisterMsgHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MsgServer) error {
	...
	mux.Handle("POST", pattern_Msg_CreateVestingAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
var (
	pattern_Msg_CreateVestingAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"orbit", "v1", "create_vesting_account"}, "", runtime.AssumeColonVerbOpt(true)))
)
