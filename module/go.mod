...
replace (
	// fix error "github.com/cometbft/cometbft@v0.34.29/crypto/secp256k1/secp256k1.go:131:14: assignment mismatch: 2 variables but ecdsa.SignCompact returns 1 value"
	github.com/btcsuite/btcd/btcec/v2 => github.com/btcsuite/btcd/btcec/v2 v2.3.2

	// Lock us into the v0.46 line
