...
// Note: This is copied from github.com/cosmos/cosmos-sdk over at server/config/config.go
// with the minor change of modifying the minimum-gas-prices string
const GravityAppConfigTemplate = `# This is a TOML config file.
